...
namespace TunNetCom.SilkRoadErp.Sales.Api.Features.ProviderInvoices.ExportToExcel;

public class ExportProviderInvoicesToExcelEndpoint : ICarterModule
{
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        _ = app.MapGet("/api/provider-invoices/export/excel", HandleExportToExcelAsync)
    ...
    public static async Task<Results<FileContentHttpResult, StatusCodeHttpResult>> HandleExportToExcelAsync(
        ...
        [FromServices] ILogger<ExportProviderInvoicesToExcelEndpoint> logger,
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            logger.LogInformation(
                "ExportProviderInvoicesToExcelEndpoint called with startDate: {StartDate}, endDate: {EndDate}, providerId: {ProviderId}, tagIds: {TagIds}, status: {Status}",
        ...
        {
            logger.LogError(ex, "Error exporting provider invoices to Excel format");
