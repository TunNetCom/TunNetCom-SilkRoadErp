...
public class ExportProviderInvoicesToPdfEndpoint : ICarterModule
{
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            var fileBytes = await exportService.ExportToPdfAsync(invoiceList, columnsToExport, "Liste des Factures Fournisseurs", decimalPlaces, totalNetAmount, totalVatAmount, totalTtcAmount, cancellationToken);
