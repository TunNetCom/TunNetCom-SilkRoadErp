...
public class UpdateCompteBancaireValidator : AbstractValidator<UpdateCompteBancaireCommand>
{
    public UpdateCompteBancaireValidator()
    {
        _ = RuleFor(x => x.Id).GreaterThan(0).WithMessage("id_is_required");
