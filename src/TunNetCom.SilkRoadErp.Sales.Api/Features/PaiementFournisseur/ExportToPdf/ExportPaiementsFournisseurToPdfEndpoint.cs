        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            logger.LogInformation(
                "ExportPaiementsFournisseurToPdfEndpoint called with fournisseurId: {FournisseurId}, accountingYearId: {AccountingYearId}, dateEcheanceFrom: {DateEcheanceFrom}, dateEcheanceTo: {DateEcheanceTo}, montantMin: {MontantMin}, montantMax: {MontantMax}, hasNumeroTransactionBancaire: {HasNumeroTransactionBancaire}",
