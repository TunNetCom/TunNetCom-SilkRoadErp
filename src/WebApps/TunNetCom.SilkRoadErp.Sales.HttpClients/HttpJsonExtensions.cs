...
namespace TunNetCom.SilkRoadErp.Sales.HttpClients
{
    ...
    public static class HttpClientJsonExtensions
    {
        ...
        {
            var requestJson = System.Text.Json.JsonSerializer.Serialize(content, jsonSerializerOptions ?? JsonSerializerOptions)!;
        ...
        public static async Task<T> ReadJsonAsync<T>(this HttpResponseMessage response, JsonSerializerOptions? jsonSerializerOptions = null, CancellationToken cancellationToken = default)
        {
            ...
            return System.Text.Json.JsonSerializer.Deserialize<T>(stringContent, jsonSerializerOptions ?? JsonSerializerOptions)!;
        }
