...
using TunNetCom.SilkRoadErp.Sales.WebApp.PrintEngine.Reports.Invoices;

namespace TunNetCom.SilkRoadErp.Sales.WebApp.PrintEngine;
...
public class PdfService
{
    ...
    public PdfService(ILogger<PdfService> logger, IServiceProvider serviceProvider)
    {
        _logger = logger;
