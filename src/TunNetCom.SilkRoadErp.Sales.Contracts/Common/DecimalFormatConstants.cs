...
public static class DecimalFormatConstants
{
    /// <summary>
    /// Default number of decimal places for amounts (prices, totals, etc.)
    /// </summary>
    public const int DEFAULT_DECIMAL_PLACES = 3;
    ...
    /// <summary>
    /// Format string for percentages (2 decimal places)
    /// </summary>
    public const string FORMAT_N2 = "N2";

    /// <summary>
    /// Format string for amounts (3 decimal places)
    /// </summary>
