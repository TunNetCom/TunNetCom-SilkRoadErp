...
public class CreateFactureAvoirFournisseurValidator : AbstractValidator<CreateFactureAvoirFournisseurCommand>
{
    public CreateFactureAvoirFournisseurValidator()
    {
        _ = RuleFor(x => x.Date)
