...
namespace TunNetCom.SilkRoadErp.Sales.Domain.Migrations
{
    ...
    [Migration("20260213103411_AddRetenueSourceFactureDepenseMigration")]
    partial class AddRetenueSourceFactureDepenseMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.DeliveryCar", b =>
                {
                    ...
                    b.ToTable("DeliveryCar", (string)null);
                });
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.FactureDepense", b =>
                {
                    ...
                    b.Property<decimal>("BaseHT0")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18, 3)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("BaseHT13")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18, 3)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("BaseHT19")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18, 3)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("BaseHT7")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18, 3)")
                        .HasDefaultValue(0m);
                    ...
                    b.Property<decimal>("MontantTVA0")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18, 3)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("MontantTVA13")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18, 3)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("MontantTVA19")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18, 3)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("MontantTVA7")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18, 3)")
                        .HasDefaultValue(0m);
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.FamilleProduit", b =>
                {
                    ...
                    b.ToTable("FamilleProduit", (string)null);
                });
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.LigneRetourMarchandiseFournisseur", b =>
                {
                    b.Property<int>("IdLigne")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("LigneRetourMarchandiseFournisseur", (string)null);
                });
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.PrintHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.Produit", b =>
                {
                    ...
                    b.Property<int?>("SousFamilleProduitId")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.RetenueSourceFactureDepense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RetenueSourceFactureDepense");
                });
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.RetourMarchandiseFournisseur", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK_dbo.RetourMarchandiseFournisseur");
                    ...
                    b.ToTable("RetourMarchandiseFournisseur", (string)null);
                });
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.SousFamilleProduit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SousFamilleProduit", (string)null);
                });
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.Systeme", b =>
                {
                    ...
                    b.Property<string>("BanqueEntreprise")
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)")
                        .HasColumnName("banqueEntreprise");

                    b.Property<bool>("BloquerBlSansFacture")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.TejCertificatFactureDepense", b =>
                {
                    b.Property<int>("FactureDepenseId")
                        .HasColumnType("int")
                        .HasColumnName("FactureDepenseId");
                    ...
                    b.ToTable("TejCertificatFactureDepense", (string)null);
                });
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.BonDeLivraison", b =>
                {
                    ...
                    b.HasOne("TunNetCom.SilkRoadErp.Sales.Domain.Entites.DeliveryCar", "DeliveryCar")
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.LigneRetourMarchandiseFournisseur", b =>
                {
                    ...
                    b.HasOne("TunNetCom.SilkRoadErp.Sales.Domain.Entites.RetourMarchandiseFournisseur", "RetourMarchandiseFournisseurNavigation")
                        .WithMany("LigneRetourMarchandiseFournisseur")
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.Produit", b =>
                {
                    b.HasOne("TunNetCom.SilkRoadErp.Sales.Domain.Entites.SousFamilleProduit", "SousFamilleProduit")
                        .WithMany("Produits")
                        .HasForeignKey("SousFamilleProduitId")
                        .OnDelete(DeleteBehavior.SetNull)
            ...
            modelBuilder.Entity("TunNetCom.SilkRoadErp.Sales.Domain.Entites.SousFamilleProduit", b =>
                {
                    b.HasOne("TunNetCom.SilkRoadErp.Sales.Domain.Entites.FamilleProduit", "FamilleProduit")
