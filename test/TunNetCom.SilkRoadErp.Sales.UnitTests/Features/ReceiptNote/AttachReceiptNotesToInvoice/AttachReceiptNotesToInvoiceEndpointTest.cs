...
{
    public class AttachReceiptNotesToInvoiceEndpointTest
    {
        private readonly Mock<IMediator> _mediatorMock;
        private readonly AttachReceiptNotesToInvoiceEndpoint _endpoint;
        public AttachReceiptNotesToInvoiceEndpointTest()
        {
            _mediatorMock = new Mock<IMediator>();
            _endpoint = new AttachReceiptNotesToInvoiceEndpoint();
        }
        // Méthode utilitaire pour simuler l’appel de l’endpoint
